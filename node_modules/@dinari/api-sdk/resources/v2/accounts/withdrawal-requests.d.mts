...
export declare class WithdrawalRequests extends APIResource {
     ...
     * ```
     */
    create(accountID: string, body: WithdrawalRequestCreateParams, options?: RequestOptions): APIPromise<WithdrawalRequest>;
    /**
     ...
     * ```
     */
    retrieve(withdrawalRequestID: string, params: WithdrawalRequestRetrieveParams, options?: RequestOptions): APIPromise<WithdrawalRequest>;
    /**
