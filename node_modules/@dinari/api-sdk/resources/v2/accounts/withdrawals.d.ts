...
export declare class Withdrawals extends APIResource {
     ...
     * ```
     */
    retrieve(withdrawalID: string, params: WithdrawalRetrieveParams, options?: RequestOptions): APIPromise<Withdrawal>;
    /**
...
export declare namespace Withdrawals {
    export { type Withdrawal as Withdrawal, type WithdrawalListResponse as WithdrawalListResponse, type WithdrawalRetrieveParams as WithdrawalRetrieveParams, type WithdrawalListParams as WithdrawalListParams, };
}
